...
-- Q.7 Find the average quantity of products sold for each product line to male customers.
...
-- Q.12 Calculate the total sales amount for each branch where the average customer rating is greater than 7 and remove the branch E.
...
-- Q.20 Calculate the total orders amount & total order count for morning (6 AM to 12 PM), afternoon (12 PM to 6 PM), and evening (6 PM to 12 AM) periods using the time condition.
